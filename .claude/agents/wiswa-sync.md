...
When a managed file is modified directly (e.g. manual `package.json` edits), you update
...
3. **Read the relevant defaults** (`defaults.libjsonnet`, etc.) to determine what is already
   provided by Wiswa.
