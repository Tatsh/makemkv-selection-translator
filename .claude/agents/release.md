...
Prepares and publishes a new release for the makemkv-selection-translator project.
...
1. **Update GitHub release notes** using `gh` (authenticated for this repository). After the tag
   ...
   - **Full Changelog line:** After the body, append **one blank line**, then exactly:
     `**Full Changelog**: https://github.com/Tatsh/makemkv-selection-translator/compare/vPREV...vNEW`
